    ...
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-3">
        <Card className="text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Materi</p>
        </Card>
        <Card className="text-center">
        ...
        <Card className="text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Soal Aktif</p>
        </Card>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <Link href="/admin/materi">
          <Card className="hover:shadow-md transition cursor-pointer">
            <h3 className="font-semibold text-slate-800">📚 Kelola Materi</h3>
            <p className="text-sm text-slate-500 mt-1">Tambah, edit, atau hapus materi edukasi.</p>
          </Card>
        </Link>
        <Link href="/admin/kuis">
          <Card className="hover:shadow-md transition cursor-pointer">
            <h3 className="font-semibold text-slate-800">🧠 Kelola Soal Kuis</h3>
            <p className="text-sm text-slate-500 mt-1">Tambah, edit, aktif/nonaktifkan soal.</p>
          </Card>
        </Link>
      </div>
    </div>
